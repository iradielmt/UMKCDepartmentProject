  ...
  <title> Apply </title>
	...
	<section class="ftco-section">
        ...
        <div class="row mt-4">
          ...
          <div>
            <label for="" class="mt-1">Are you GTA certified? If so, which term did you complete your certification? If you have a previous degree from a US Institute, please indicate this as that waives GTA certification
        </label>
          </div>
          <div class="col-md-6">
